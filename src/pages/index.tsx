  ...
  return (
    <>
          ...
          <div className="grid grid-rows-3">
            <div className="bg-white border rounded h-fit row-span-2">
              <p className="font-calsans text-4xl p-[30px]">
                TagMe is an online service that outsources data so that it can
                be labeled and be used to train tools like machine learning
                algorithms and social media recommendation systems. Anyone can
                make money by simply completing the tag tasks listed in the link
                below. You can also post your own tasks to create your own
                dataset!
              </p>
            </div>
      ...
      <div className="h-28 w-screen grid grid-cols-2 bg-slate-900" id="contact">
        <div></div>
        <div>
          <h1 className="text-white font-calsans text-2xl">
